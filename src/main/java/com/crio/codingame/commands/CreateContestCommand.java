...
public class CreateContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        Integer numOfQuestions = tokens.size()==4 ? null : Integer.parseInt(tokens.get(4));
        try{
        Contest contest = contestService.create(tokens.get(1), Level.valueOf(tokens.get(2)), tokens.get(3), numOfQuestions);
